...
<div class="layui-container">
    <div class="admin-login-background">
        <div class="layui-form login-form">
            <form id="login" class="layui-form" action="${path}/login" method="post">
                <div class="layui-form-item logo-title">
                    <h1>校园通</h1>
                </div>
                <div class="layui-form-item">
                    <label class="layui-icon layui-icon-username" ></label>
                    <select style="WIDTH: 156px;border:1px solid #fff;color:#666;" name="userType" onchange="CheckType(this)">
                    <option value="Student" usrid="学　号">学生</option>
                    <option value="Teacher" usrid="工　号">教师</option>
                    <option value="Admin" usrid="帐　号">管理员</option>
                </select>
                </div>
                <div class="layui-form-item">
                    <label class="layui-icon layui-icon-username" ></label>
...
<script>
    ...
    function registerForm() {
        console.log("开始调用登录方法")
        $.get("${path}/registerUser",function (str) {
            var resisterIndex = layer.open({
                ...
                yes : function (index) {
                    ...
                    $.post('${path}/registerUser',params2,function (data) {
